...
export const ENV_DOCS_WEBAPP_WEBSITE_DOMAIN = 'shared.example.domain.com';
export const ENV_DOCS_WEBAPP_WEBSITE_TITLE = 'Shared';
...
export const ENV_DOCS_WEBAPP_BUILD_ANGULAR_PROD = undefined;
...
export const ENV_DOCS_WEBAPP_LOADING_AFTER_ANGULAR_BOOTSTRAP_LOADER = undefined;
export const ENV_DOCS_WEBAPP_LOADING_AFTER_ANGULAR_BOOTSTRAP_BACKGROUND = undefined;
